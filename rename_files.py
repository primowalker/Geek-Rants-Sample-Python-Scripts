...
''' The rename_file.py scripts take the full path to the directory
	...
	One of the benefits of this script over other file renaming
	scripts I have seen is that this script doen't require you 
	to enter the name of the file extension. This is particularly
	helpful in cases where there are files with mixed extensions
